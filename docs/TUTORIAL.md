...
event records (`@GenerateSchema` + `@EventMapping`), the generated JSON Schemas, and two
...
section 4, you understand all seven events — the only new code for an eighth event is a new record
