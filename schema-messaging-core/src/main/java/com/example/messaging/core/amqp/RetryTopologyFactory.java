 ...
 * code-first D3). Tier 0 = 5s, tier 1 = 30s, tier 2 = 5m. Each retry queue dead-letters back to
 * events.exchange with the original routing key, and is bound to events.retry.exchange.
 *
 * <p>Hoisted into {@code schema-messaging-core}: the topology is a transport concern generated once
 * and driven by contract metadata (the {@code TypeMappingRegistry}), never hand-authored per domain.
 */
