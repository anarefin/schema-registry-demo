...
/**
 * T-3.5: one {@code @RabbitListener} per customer queue, each receiving the typed code-first record.
 *
...
public class CustomerEventListener {
    ...
    @RabbitListener(queues = CustomerEventRouting.ADDRESS_ADDED_QUEUE,
                    containerFactory = "rabbitListenerContainerFactory")
    ...
    @RabbitListener(queues = CustomerEventRouting.TIER_CHANGED_QUEUE,
                    containerFactory = "rabbitListenerContainerFactory")
