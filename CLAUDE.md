...
DLX/DLQ/retry failure topology. All contracts are **code-first**: immutable Java classes are the source of
...
- **`order-contracts`** — four code-first order event classes + generated schemas
